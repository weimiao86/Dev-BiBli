...
def show_desktop(dstp):
	if dstp=='show':
		subprocess.call("sudo fbi -T 2 -d /dev/fb1 -noverbose -a /home/pi/BiBli/media/image/bg2.jpg", shell=True)
...
def playvideo(checktext):
	...
	subprocess.call("mplayer -vo fbdev2:/dev/fb1 -x 240 -y 320 -framedrop -quiet -input file=/home/pi/fifos /home/pi/BiBli/media/video/"+ vname+" < /dev/null &", shell=True)
